        ...
        <div className="flex items-center justify-between">
          ...
          {!isOutOfStock ? (
            quantity === 0 ? (
              <button
                onClick={handleAdd}
                className="flex items-center gap-1.5 bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 rounded-xl text-sm font-semibold transition-all active:scale-95 shadow-md"
              >
              ...
              <div className="flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-xl px-1 py-1">
                ...
                <button
                  ...
                  className="w-7 h-7 flex items-center justify-center bg-orange-500 rounded-lg text-white hover:bg-orange-600 transition-colors shadow-sm"
                >
